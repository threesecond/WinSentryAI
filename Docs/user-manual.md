...
The following standalone documents are retained as focused references:

- [AI Provider Free / Trial API Resources](free-api-resource.md)
- [Remote Connection Setup](remote-connection-setup.md)
